...
PLC_Node::GetTypeId (void)
{
	static TypeId tid = ns3::TypeId("ns3::PLC_Node")
    		...
    		.AddAttribute("Node_Id", "identifier of the node", TypeId::ATTR_GET | TypeId::ATTR_CONSTRUCT, UintegerValue(0), MakeUintegerAccessor(&PLC_Node::m_vertex_id), MakeUintegerChecker<unsigned int>())
    		...
    		.AddAttribute("Open_Circuit", "indicates infinity impedance", BooleanValue(true), MakeBooleanAccessor(&PLC_Node::m_open_circuit), MakeBooleanChecker())
    		;
	return tid;
}
...
PLC_Node::SetImpedance(Ptr<PLC_Impedance> impedance)
{
	...
	NS_LOG_LOGIC("Node_Id: " << m_vertex_id);
